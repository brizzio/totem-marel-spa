...
const SearchModal = ({ btnTitle, update }) =>{ 
  ...
  const onClose = useCallback(() => {
    console.log("value", modalRef.current.returnValue);
      ...
      {!isOpen ? (
        ...
        >
          <form className="w-[30rem] h-auto flex flex-col items-center gap-6 "
            ...
            <p className=" text-left text-blue font-thin text-3xl px-3 self-center w-[18rem] my-3 ">Inserisci il codice del prodotto per fare una ricerca.</p>
            <div className="flex flex-row gap-3 w-full justify-center">
                ...
                <button 
                className="bg-green-600 rounded-xl text-white p-4"
